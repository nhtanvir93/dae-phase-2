...
class ConfigAttachment extends Model
{
    use SoftDeletes;

    protected $table = 'config_attachments';
    ...
    {
        return $this->belongsToMany(AppType::class, 'config_app_type_attachments')->whereNull('config_app_type_attachments.deleted_at');
    }
