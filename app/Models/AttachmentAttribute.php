...
class AttachmentAttribute extends Model
{
    use SoftDeletes;

    protected $table = 'attachment_attributes';
    ...
    protected $with = [
        'configAttachment:id,name', 'configAttachmentAttribute:id,name'
    ];
    ...
    public function configAttachmentAttribute()
    {
        return $this->belongsTo(ConfigAttachmentAttribute::class);
    }
