...
class ConfigAppTypeAttachment extends Model
{
    use SoftDeletes;

    protected $table = 'config_app_type_attachments';
    ...
    public function attachmentAttributes() {
        return $this->hasMany(ConfigAttachmentAttribute::class,
            'config_attachment_id', 'config_attachment_id')->whereNull('config_attachment_attributes.deleted_at');
    }
